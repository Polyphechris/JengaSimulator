    ...
    class Stars : ParticleSystem
    {
        ...
        public override void initialize()
        {
            ...
            for (int i = 0; i < STAR_COUNT; ++i)
            {
                ...
                newParticle.Initialize(m, new Vector3((float)posX, (float)posY, (float)posZ), Vector3.Zero, Vector3.Zero, new Vector3(0.8f, 0.8f, 0.8f), 0.7f, new Vector3(0.075f), 1);
