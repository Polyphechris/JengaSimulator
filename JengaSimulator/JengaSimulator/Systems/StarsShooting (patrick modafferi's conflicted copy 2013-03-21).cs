...
namespace PatrickModafferiA2.Systems
{
    class StarsShooting : ParticleSystem
    {
        ...
        const int INITIAL_UP_VELOCITY = 50;
        ...
        public void spawnStar(Vector3 position)
        {
            ...
            Vector3 unitV = new Vector3((float)Math.Cos(r), 0, (float)Math.Sin(r));
        ...
        public override void update(float time)
        {
            for (int i = 0; i < particles.Count; ++i)
            {
                ...
                trail.Initialize(particles.ElementAt(i).model, currentP.position, Vector3.Zero, Vector3.Zero, new Vector3(0.5f, 0.5f, 0.5f), 1, new Vector3(0.2f), 1);
